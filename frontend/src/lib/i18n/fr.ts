...
export const fr = {
  ...
  "landing.pricing.free3": "Recherche de financements",
  ...
  "landing.pricing.pro2": "300 crédits IA par mois",
  "landing.pricing.pro3": "Analyse de compatibilité des financements",
  "landing.pricing.pro4": "Export PDF et Word du dossier",
  "landing.pricing.pro5": "Chaîne d'agents : dossier contrôlé de bout en bout",
  ...
  "landing.pricing.producer1": "Projets illimités",
  "landing.pricing.producer2": "500 crédits IA par mois — le plus gros volume",
  "landing.pricing.producer3": "Analyse de compatibilité des financements",
  "landing.pricing.producer4": "Export PDF et Word du dossier",
  "landing.pricing.producer5": "Chaîne d'agents : dossier contrôlé de bout en bout",
